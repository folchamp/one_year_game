 ...
 *
 * requiresOneOf: ["A", "B", "C"]
 *     → une seule de ces trois connaissances suffit
 *
 * get:
 *     → ressource produite par l'action
 *
 * learn:
 *     → connaissances susceptibles d'être découvertes par l'action
 *
 * displayName:
 *     → nom français affiché au joueur
 *
 * Les ressources sont volontairement reliées entre elles par les
 * connaissances plutôt que par des chaînes technologiques rigides.
 */
